...
selected_example = st.selectbox("เลือกตัวอย่าง SQL", list(example_queries.keys()))
if "duckdb_sql_text" not in st.session_state:
...
with col_b:
    st.caption("เลือกตัวอย่างแล้วกดปุ่มด้านซ้าย หรือเขียน SQL เองได้เลย")
